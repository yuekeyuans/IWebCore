...
////            auto type = field.type();
////            if(type >= QMetaType::User){
////                auto ptr = (IBeanWare*)QMetaType::create(type);
//////                obj->load(obj[field.name()]);
////                field.writeOnGadget(this, QVariant(type, ptr));
//////                QMetaType::destroy(ptr);

////            }else{
////                switch (type) {
////                case QMetaType::Bool:
////                    field.writeOnGadget(this, QVariant(obj[field.name()]));
////                    break;
////                case QMetaType::UChar:
////                case QMetaType::SChar:
////                case QMetaType::Char:

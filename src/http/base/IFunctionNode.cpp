...
IFunctionNode IFunctionNode::createFunctionNode(std::function<void(const IRequest &, IResponse&)> functor)
{
    ...
    IParameterNode reqNode = ISpawnUtil::construct<IParameterNode, int, QString, QString>(QMetaType::type("IRequest&"), "IRequest&", "request");
    IParameterNode resNode = ISpawnUtil::construct<IParameterNode>(QMetaType::type("IResponse&"), "IResponse&", "response");

...
public:
    static QString toString(IHttpStatus::Code);
    static QString toStringDescription(IHttpStatus::Code);
    static IHttpStatus::Code toStatus(int);
    static IHttpStatus::Code toStatus(const QString&);
    static bool contain(int);
};

using IHttpStatusCode = IHttpStatus::Code;

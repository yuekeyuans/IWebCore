...
public:
    ...
    using CreateParamFunType = void*(IHttpControllerParameter::*)(const IParamNode& node, IRequest& request, bool& ok);
    using ReleaseParamFunType = bool (IHttpControllerParameter::*)(const IParamNode& node, void *obj);

...
private:
    ...
    void processInMethodMode(IRequest &request, IResponse &response, IHttpAction *node);
    void processInFunctionMode(IRequest &request, IResponse &response, IHttpAction *node);

...
void IHttpRequestHandler::handleRequest(IRequest &request, IResponse &response)
{
    ...
    case IRequestRaw::ProcessUnit::Function:
    {
        ...
        if(function->type == IHttpAction::CallableType::Method){
...
void IHttpRequestHandler::processInMethodMode(IRequest &request, IResponse &response, IHttpAction *node)
{
...
void IHttpRequestHandler::processInFunctionMode(IRequest &request, IResponse &response, IHttpAction *node)
{
